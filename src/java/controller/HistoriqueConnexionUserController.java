...
import service.HistoriqueConnexionUserFacade;
...
@Named("historiqueConnexionUserController")
@SessionScoped
public class HistoriqueConnexionUserController implements Serializable {

    @EJB
    private service.HistoriqueConnexionUserFacade ejbFacade;
    private List<HistoriqueConnexionUser> items = null;
    ...
    private HistoriqueConnexionUserFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("HistoriqueConnexionUserCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("HistoriqueConnexionUserUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("HistoriqueConnexionUserDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public HistoriqueConnexionUser getHistoriqueConnexionUser(java.lang.Long id) {
    ...
    public static class HistoriqueConnexionUserControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            HistoriqueConnexionUserController controller = (HistoriqueConnexionUserController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "historiqueConnexionUserController");
            return controller.getHistoriqueConnexionUser(getKey(value));
        }
