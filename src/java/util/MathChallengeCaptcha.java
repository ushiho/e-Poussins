...
public class MathChallengeCaptcha {
    ...
    private Random gen;
    private MD5HashUtil md5;
    private int oprnd1, oprnd2, oprtr, ans, max;
    private String hash;

    /**
     * Initializes this MathChallengeCaptcha object with 10 as maximum possible
     * value of numbers used in generated challenge.
     *
    ...
    /**
     * Initializes this MathChallengeCaptcha object with provided maximum
     * possible value of numbers used in generated challenge.
     *
     * @throws NoSuchAlgorithmException
     */
    ...
    /**
     * Gets Mathematical Challenge as a JSON String that contains an expression
     * values; operand1, operand2, operator and MD5 Hash code of answer.
     * Example: If challenge is 2 * 5 = 10, then it will represented as
     * following Key-Value pairs in JSON String.
     *
     * operand1 : 2 operand2 : 5 operator : '*' answerhash :
